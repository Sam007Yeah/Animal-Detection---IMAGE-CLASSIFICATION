...
# image_path = "drive/MyDrive/PROJECT/TEST/SEEN DATA/cow.jpeg"  # Change this to the path of your image
# predicted_label, predicted_probability = predict_single_image(image_path, model)#, predicted_probability
# print("Predicted Label:", predicted_label)
# print("Predicted Probability:", predicted_probability)
...
def predict_images_in_folder(folder_path, model, class_indices):
    for filename in os.listdir(folder_path):
        if filename.endswith(('.jpg', '.jpeg', '.png')):  # Assuming images are in these formats
            ...
            predicted_label, predicted_probability = predict_single_image(image_path, model, class_indices)
...
folder_path = "drive/MyDrive/PROJECT/TEST/UNSEEN DATA"  # Change this to the folder containing your images
predict_images_in_folder(folder_path, model, tc)
